...
export default function HomePage() {
  return (
    <div className="site-body">
      ...
      {/* ── CLASSES PREVIEW ── */}
      <section style={{ borderBottom: '1px solid var(--rule)' }}>
        <div className="sp mob-vpad" style={{ maxWidth: '1280px', margin: '0 auto', padding: '88px 48px' }}>
          <ScrollReveal>
            ...
            <div className="r3" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1px', background: 'var(--rule)', border: '1px solid var(--rule)' }}>
              {memberships.testimonials.map((t, i) => (
                <div key={i} style={{ background: 'var(--linen)', padding: '40px 36px 44px', display: 'flex', flexDirection: 'column' }}>
                  <div style={{ borderBottom: '1px solid var(--rule)', paddingBottom: '20px', marginBottom: '24px' }}>
                  ...
                  <blockquote style={{
                    ...
                    fontWeight: 300, color: 'var(--esp)', lineHeight: 1.45, margin: 0, flex: 1,
                  }}>
                    &ldquo;{t.quote}&rdquo;
                  </blockquote>
                </div>
