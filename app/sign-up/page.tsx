  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const regRes = await fetch('/api/auth/register', {
        ...
        body:    JSON.stringify({ email: form.email, password: form.password, firstName: form.firstName, lastName: form.lastName, phone: form.phone, suburb: form.suburb, plan: isFree && !isExisting ? planKey : undefined }),
      })
