  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-neutral-50">
      ...
      <div className="md:hidden flex flex-col items-center justify-center h-full px-8 text-center">
        ...
        <h2 className="text-[15px] font-semibold text-neutral-900 mb-2">Desktop only</h2>
        <p className="text-[13px] text-neutral-500 leading-relaxed">
          The POS is designed for use on a desktop or tablet. Please switch to a larger screen to process payments.
        </p>
      </div>
