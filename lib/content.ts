  ...
  plans: [
    {
      ...
      tagline:  'All classes, unlimited. Weekly direct debit — cancel with 7 days\' notice.',
      amount:   '$62',
      period:   '/ week',
      equiv:    '≈ $8.86 per day',
      featured: false,
    ...
    },
    {
      ...
      name:     '3 Months',
      planKey:  '3month',
      tagline:  'Three months of unlimited classes, paid upfront. No weekly commitment.',
      amount:   '$669',
      period:   'upfront',
      equiv:    '≈ $223 per month',
      featured: true,
    ...
    },
    {
      ...
      name:     '6 Months',
      planKey:  '6month',
      tagline:  'Six months of unlimited classes at a lower monthly rate.',
      amount:   '$1,199',
      period:   'upfront',
      equiv:    '≈ $200 per month',
      featured: false,
    ...
    },
    {
      ...
      name:     '12 Months',
      planKey:  '12month',
      tagline:  'A full year of unlimited classes — our best rate per month.',
      amount:   '$2,199',
      period:   'upfront',
      equiv:    '≈ $183 per month',
      featured: false,
