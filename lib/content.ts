...
export const classTypes = [
  ...
  },
  {
    ...
    duration:  '45 min',
    level:     'All levels',
    tags:      ['Sweat', 'Power', 'Conditioning'],
    color:     'special',
    desc:      'A fast-paced, full-body workout combining strength and cardio in timed intervals. Designed to build endurance, burn calories, and boost overall fitness — high energy, results-driven, and suitable for all levels.',
    priceNote: 'Included in all memberships',
  },
  {
    slug:      'bikram-yoga',
    ...
    color:     'sage',
    desc:      'A structured sequence of 26 postures and breathing exercises practiced in a heated room. Designed to improve flexibility, strength, and mental focus while supporting detoxification — suitable for all levels, go at your own pace.',
    priceNote: 'Included in all memberships',
  },
  {
    slug:      'bikram-express',
    ...
    color:     'sage',
    desc:      'A shorter version of the traditional Bikram sequence, delivering the same benefits in a more time-efficient format. Perfect for those wanting a focused, effective practice — all levels welcome.',
    priceNote: 'Included in all memberships',
  },
  {
    ...
    duration:  '60 min',
    level:     'All levels',
    tags:      ['Strength', 'Control', 'Tone'],
    color:     'rust',
    desc:      'A heated, mat-based Pilates class focused on core strength, stability, and full-body toning. Controlled movements and intentional pacing create a strong, balanced workout — suitable for all levels.',
    priceNote: 'Included in all memberships',
  },
  {
    slug:      'special-forces',
  ...
  },
  {
    ...
    duration:  '45 min',
    level:     'All levels',
    tags:      ['Cardio', 'Power', 'Conditioning'],
    color:     'barre',
    desc:      'A high-energy, non-contact workout combining boxing combinations with cardio bursts. Build strength, improve coordination, and boost endurance while releasing stress and energy — all levels welcome.',
    priceNote: 'Included in all memberships',
  },
]
