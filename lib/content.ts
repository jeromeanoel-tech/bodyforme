...
export const memberships = {
  ...
  plans: [
    {
      tag:      'Unlimited membership',
      name:     'All Classes',
      planKey:  'weekly-unlimited',
      tagline:  'Unlimited access to every class type — Pilates, Hot Yoga, Boxing, Fitness and Bikram. Weekly direct debit, cancel with 7 days\' notice.',
      amount:   '$62',
      period:   '/ week',
      equiv:    'Includes every class type',
      featured: true,
      badge:    'Most popular',
      features: [
        'Unlimited classes',
