...
export const memberships = {
  ...
  plans: [
    {
      ...
      tagline:  'Unlimited access to every class type. Weekly direct debit, cancel with 7 days\' notice.',
      amount:   '$62',
      period:   '/ week',
      equiv:    'All class types included',
      featured: true,
      badge:    'Most popular',
      features: [
        'Unlimited classes',
    ...
    },
    {
      ...
      name:     '3 Per Week',
      planKey:  'weekly-3',
      tagline:  '3 classes per week. Weekly direct debit, cancel with 7 days\' notice.',
      amount:   '$45',
      period:   '/ week',
      equiv:    '3 classes per week',
      featured: false,
      badge:    '',
      features: [
        '3 classes per week',
    ...
    },
    {
      ...
      name:     '3 Months',
      planKey:  '3month',
      tagline:  'Three months of unlimited classes, paid upfront. No weekly lock-in.',
      amount:   '$669',
      period:   'upfront',
      equiv:    '≈ $223 per month',
      featured: false,
  ...
  packs: [
    { name: '3 Per Week',        planKey: 'weekly-3',    price: '$45/wk', detail: '3 classes per week · Weekly direct debit · Cancel with 7 days\' notice' },
...
export const signupPlans: Record<string, {
  ...
  'intro-offer': {
    ...
    amount:      4900,
    period:      '$49 once',
    description: 'All classes, unlimited, for 7 days. New members only.',
    mode:        'payment',
    features:    ['All class types', 'Unlimited for 7 days', 'New members only'],
  },
  'weekly-3': {
    name:            '3 Per Week',
    tag:             'Flexible',
  ...
  '10pack': {
    ...
    amount:      28000,
    period:      '$280 once',
    description: '10 classes at $28 per class.',
    mode:        'payment',
    features:    ['10 classes', '$28 per class', 'Any class type', 'No expiry'],
  },
  '20pack': {
    name:        '20 Class Pack',
    tag:         'Great value',
    amount:      50000,
    period:      '$500 once',
    description: '20 classes at $25 per class.',
    mode:        'payment',
    features:    ['20 classes', '$25 per class', 'Any class type', 'No expiry'],
  },
  '50pack': {
    name:        '50 Class Pass',
    tag:         'Best pass value',
  ...
  '3month': {
    ...
    amount:      66900,
    period:      '$669 once',
    description: 'Unlimited classes for 3 months. Equivalent to $223/month.',
    mode:        'payment',
    features:    ['Unlimited classes for 3 months', 'All class types', '$223 / month equivalent'],
  },
  '6month': {
